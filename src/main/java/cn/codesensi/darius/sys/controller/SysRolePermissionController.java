...
import cn.codesensi.darius.sys.entity.SysRolePermission;
import cn.codesensi.darius.sys.service.ISysRolePermissionService;
...
public class SysRolePermissionController extends BaseController {
     ...
     */
    @OperateLog(operateType = OperateType.INSERT, description = "新增一条角色权限关联表数据")
     ...
     * @param id 主键id
     */
    @OperateLog(operateType = OperateType.DELETE, description = "根据id删除一条角色权限关联表数据")
     ...
     * @param sysRolePermission 实体类
     */
    @OperateLog(operateType = OperateType.UPDATE, description = "根据id更新一条角色权限关联表数据")
     ...
     */
    // @OperateLog(operateType = OperateType.QUERY, description = "条件查询角色权限关联表分页列表", isSaveResponseData = false)
     ...
     */
    // @OperateLog(operateType = OperateType.QUERY, description = "根据id查询角色权限关联表详情")
