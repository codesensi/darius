...
public class SysPermissionController extends BaseController {
     ...
     */
    @OperateLog(operateType = OperateType.INSERT, description = "新增一条权限信息表数据")
     ...
     * @param id 主键id
     */
    @OperateLog(operateType = OperateType.DELETE, description = "根据id删除一条权限信息表数据")
     ...
     * @param sysPermission 实体类
     */
    @OperateLog(operateType = OperateType.UPDATE, description = "根据id更新一条权限信息表数据")
     ...
     */
    // @OperateLog(operateType = OperateType.QUERY, description = "条件查询权限信息表分页列表", isSaveResponseData = false)
     ...
     */
    // @OperateLog(operateType = OperateType.QUERY, description = "根据id查询权限信息表详情")
