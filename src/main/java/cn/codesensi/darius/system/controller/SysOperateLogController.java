...
public class SysOperateLogController {
     ...
     */
    @OperateLog(operateType = OperateTypeEnum.INSERT, description = "新增一条sysOperateLog数据")
     ...
     * @param id 主键id
     */
    @OperateLog(operateType = OperateTypeEnum.DELETE, description = "根据id删除一条sysOperateLog数据")
     ...
     * @param sysOperateLog 实体类
     */
    @OperateLog(operateType = OperateTypeEnum.UPDATE, description = "根据id更新一条sysOperateLog数据")
     ...
     */
    @OperateLog(operateType = OperateTypeEnum.QUERY, description = "条件查询sysOperateLog分页列表")
     ...
     */
    @OperateLog(operateType = OperateTypeEnum.QUERY, description = "根据id查询sysOperateLog详情")
