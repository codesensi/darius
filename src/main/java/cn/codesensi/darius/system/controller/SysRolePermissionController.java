...
public class SysRolePermissionController {
     ...
     */
    @OperateLog(operateType = OperateTypeEnum.INSERT, description = "新增一条sysRolePermission数据")
     ...
     * @param id 主键id
     */
    @OperateLog(operateType = OperateTypeEnum.DELETE, description = "根据id删除一条sysRolePermission数据")
     ...
     * @param sysRolePermission 实体类
     */
    @OperateLog(operateType = OperateTypeEnum.UPDATE, description = "根据id更新一条sysRolePermission数据")
     ...
     */
    @OperateLog(operateType = OperateTypeEnum.QUERY, description = "条件查询sysRolePermission分页列表")
     ...
     */
    @OperateLog(operateType = OperateTypeEnum.QUERY, description = "根据id查询sysRolePermission详情")
