...
public class SysUserRoleController {
     ...
     */
    @OperateLog(operateType = OperateTypeEnum.INSERT, description = "新增一条sysUserRole数据")
     ...
     * @param id 主键id
     */
    @OperateLog(operateType = OperateTypeEnum.DELETE, description = "根据id删除一条sysUserRole数据")
     ...
     * @param sysUserRole 实体类
     */
    @OperateLog(operateType = OperateTypeEnum.UPDATE, description = "根据id更新一条sysUserRole数据")
     ...
     */
    @OperateLog(operateType = OperateTypeEnum.QUERY, description = "条件查询sysUserRole分页列表")
     ...
     */
    @OperateLog(operateType = OperateTypeEnum.QUERY, description = "根据id查询sysUserRole详情")
