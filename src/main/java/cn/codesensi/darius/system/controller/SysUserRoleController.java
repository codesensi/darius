...
import cn.codesensi.darius.system.entity.SysUserRole;
import cn.codesensi.darius.system.service.ISysUserRoleService;
...
public class SysUserRoleController {
     ...
     */
    @OperateLog(operateType = OperateType.INSERT, description = "新增一条sysUserRole数据")
     ...
     * @param id 主键id
     */
    @OperateLog(operateType = OperateType.DELETE, description = "根据id删除一条sysUserRole数据")
     ...
     * @param sysUserRole 实体类
     */
    @OperateLog(operateType = OperateType.UPDATE, description = "根据id更新一条sysUserRole数据")
     ...
     */
    // @OperateLog(operateType = OperateType.QUERY, description = "条件查询sysUserRole分页列表", isSaveResponseData = false)
     ...
     */
    // @OperateLog(operateType = OperateType.QUERY, description = "根据id查询sysUserRole详情")
